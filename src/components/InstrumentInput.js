...
class InstrumentInput extends Component {
  ...
  render() {
    if (this.state.renderForm === false){
      ...
      {/* input form contains inputs for the fields specified in the backend database's "instruments" table */}
      return (
        <div className="storeInfo">
          <form onSubmit={event => this.handleOnSubmit(event)}>
            <input type="text" placeholder="Type of Instrument" value={this.state.type} onChange={this.handleTypeChange}/><br/>
